...
public class Faker {
    ...
    public Faker(Random random) {
        this(Locale.SIMPLIFIED_CHINESE, random);
    }
    ...
    public Faker(Locale locale, RandomService randomService) {
        this(locale, new FakeValuesService(locale, randomService), randomService);
    }

    public Faker(Locale locale, FakeValuesService fakeValuesService, RandomService random) {
        this.locale = locale;
    ...
    /**
     * This method returns the gender object
     *
